package com.bankingmanagement.enterprise.controller;
...
import com.bankingmanagement.enterprise.service.BankService;
...
public class BankController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<BankTO> findById(@RequestParam("id") int id) throws BankDetailsNotFoundException {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Boolean> deleteBankDetailsById(@RequestParam("id") int id) throws BankDetailsNotFoundException {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<BankTO> update(@RequestParam("id") int id, @RequestBody @Valid BankRequest bankRequest) throws BankDetailsNotFoundException{
